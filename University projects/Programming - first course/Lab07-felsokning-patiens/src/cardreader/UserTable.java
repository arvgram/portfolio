...
public class UserTable {
	...
	public void add(User u) {
		...
		users[pos] = u;
		n++; // Höjer antalet registrerade kort, detta gav fel innan
	}
	...
	public User find(int cardNbr) {
		...
		int high = n - 1;
		int mid = -1;
		while (low <= high) { // La till större än eller lika med eftersom den skippade de ggr då talet
								// matchade low=high
			mid = (low + high) / 2;
