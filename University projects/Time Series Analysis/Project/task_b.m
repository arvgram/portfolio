...
close all
d = 0;
C1 = [1 0.5 0 0 0 0 zeros(1,17) 0.5 0.5 0.5];      % C-polynomial
A1 = [1/0.6 1 1 1 0 0 zeros(1,17) 1 1 0].*0.6;      % D-polynomial
B =  [zeros(1,d) 1]*0.5;                                % B-polynomial
A2 = [1/0.6 1 0 1 zeros(1,19) 0 0 0].*0.6;          % F-polynomial
y = df_train.t_sla;
