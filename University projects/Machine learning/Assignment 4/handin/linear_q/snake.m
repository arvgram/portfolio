...
show_fraction = 0.05; % Allowed to be changed. 1: show everything, 0: show nothing, 0.1: show every tenth, and so on...
...
rewards   = struct('default', 0, 'apple', 1, 'death', -5); % Experiment with different reward signals, to see which yield a good behaviour for the agent
gamm      = 0.9;                                          % Discount factor in Q-learning
alph      = 0.99;                                           % Learning rate in Q-learning
eps       = 0.99;                                           % Random action selection probability in epsilon-greedy Q-learning (lower: increase exploitation, higher: increase exploration)
